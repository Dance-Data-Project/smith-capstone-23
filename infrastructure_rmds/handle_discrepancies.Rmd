...
```{r previous version for reference, eval=FALSE}

# previous version -- takes most recent (non-NA) value for each variable individually
...
endowment_recent %>%
  ...
  mutate(end_calc = BeginningYearBalanceAmt + ContributionsAmt -
           OtherExpendituresAmt - AdministrativeExpensesAmt -
           GrantsOrScholarshipsAmt + InvestmentEarningsOrLossesAmt) %>%
