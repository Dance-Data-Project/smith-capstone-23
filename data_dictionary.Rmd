...
varnames <- read_html("./data/html/irs_info_xi.html") 
...
The IRSx site has useful information linking variable descriptions to names.
...
variable_descriptions <- map_df(dir("./data/html", full.names= TRUE), get_var_info)
