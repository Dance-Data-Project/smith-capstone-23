...
```{r}
data_trend$quantiles = cut(data_trend$rank_pct, breaks = quantile(data_trend$rank_pct, type = 1), include.lowest = TRUE, labels = c("25%","50%","75%","100%"))
