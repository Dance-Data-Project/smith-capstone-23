...
df <- data.frame(
  ...
  TotalRevenue = c(100, 150, 200, 175, 50, 75)
)

# Group the dataframe by Company and Year, and rank the TotalRevenue column within each group
df_ranked <- df %>%
  group_by(Company, Year) %>%
  mutate(Rank = dense_rank(desc(TotalRevenue)))
