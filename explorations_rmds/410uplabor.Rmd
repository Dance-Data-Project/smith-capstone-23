...
vol_map<-ggplot(data = map_data_pct) +
...
ggsave(plot = vol_map, "~/Desktop/vol_map.png", width = 6, height = 4, dpi = 300)
```
...
ratio_bar_region<-ggplot(stack_quantile, aes(x = as.factor(quantiles), y = Percent, fill = region)) +
  geom_bar(stat = "identity", position = "stack")+
  viridis::scale_fill_viridis(discrete=TRUE,
                                 option = "rocket",
                                 end = .9)+
...
ggsave(plot =ratio_bar_region, "~/Desktop/ratio_bar_region.png", width = 6, height = 4, dpi = 300)
```
...
ggsave(plot = type_region, "~/Desktop/type_region_bar.png", width = 6, height = 4, dpi = 300)
```
