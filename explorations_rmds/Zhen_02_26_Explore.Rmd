...
index <- grepl("Land|Buildings", cols)
cols <- cols[index]
...
```{r}
# change column name and selct ones with buuildings and otherland 
# Sample data frame
my_df <- data.frame(var1_a = rnorm(5),
                     var1_b = rnorm(5),
                     var2_a = rnorm(5),
                     var2_b = rnorm(5))

# Rename columns that contain "_a"
new_names <- sub("_a", "", names(my_df))
names(my_df) <- new_names
