...
knitr::opts_chunk$set(echo = FALSE, message=FALSE, warning=FALSE, fig.width =15, fig.height=8, fig.pos = "H", out.extra = "", eval=FALSE)
```
...
ggsave(here('final_report/images/csuite-comp-bar.pdf'))
